# Validacao E2E Admin Master MX - 20260812151529

- Run ID: `E2E_ADMIN_MASTER_20260812151529`
...
| --- | --- | --- | --- |
| Runner | fatal error | FAIL | `{"message":"E2E_ADMIN_PASSWORD not set and stdin is not a TTY"}` |
| Limpeza | cleanup registry | PASS | `{"cleanupWarnings":[],"checks":[]}` |
| Limpeza | leftover verification | PASS | `{"leftovers":[],"checks":[]}` |

## Artefatos

- `output/e2e-admin-master-full-20260812151529/cleanup-registry.json`
