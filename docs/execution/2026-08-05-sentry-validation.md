...
> **Timestamp desta retificação:** `2026-08-05T08:50:00Z`
...
O Release declarado era `cd6aef78daa115fccfdf2c3e530ed00332ab6633` — este SHA **não corresponde** ao git HEAD atual (`0e285d7fc6356830ff759632e28d0d2f229dcd28`).
...
| Release atual no Sentry | Sentry release `0e285d7fc6356830ff759632e28d0d2f229dcd28` criada e com commits | `PENDING — NÃO VERIFICADO` |
...
| Source Maps | Upload dos source maps confirmado para a release `0e285d7f` | `PENDING — NÃO VERIFICADO` |
...
2. **Release real:** Verificar em `https://sentry.io/organizations/<org>/releases/0e285d7fc6356830ff759632e28d0d2f229dcd28/`
