...
const LEGACY_OVERLAY_ALLOWLIST = [
  ...
  'components/owner/blocks/DecisionModals.jsx',
  'components/owner/consulting/AnticipationModal.jsx',
  'components/owner/consulting/EvidenceTab.jsx',
  'components/owner/consulting/MeetingDrawer.jsx',
  'components/owner/consulting/ParticipantsModal.jsx',
  'components/owner/strategic/CreateActionModal.jsx',
...
const LEGACY_OVERLAY_BASELINE = {
  ...
  'components/owner/blocks/DecisionModals.jsx': { 'raw-overlay-max-size': 3 },
  'components/owner/consulting/AnticipationModal.jsx': { 'undeclared-overlay-scroll': 1, 'raw-overlay-max-size': 2 },
  'components/owner/consulting/EvidenceTab.jsx': { 'raw-overlay-max-size': 2 },
  'components/owner/consulting/MeetingDrawer.jsx': { 'undeclared-overlay-scroll': 1, 'raw-overlay-max-size': 1 },
  'components/owner/consulting/ParticipantsModal.jsx': { 'undeclared-overlay-scroll': 1, 'raw-overlay-max-size': 2 },
  'components/owner/strategic/CreateActionModal.jsx': { 'undeclared-overlay-scroll': 1, 'raw-overlay-max-size': 2 },
