...
export function AdminFeedbackModal({
  ...
  return (
    ...
    >
      <DialogContent showClose={false} ref={dialogRef} className="w-full max-w-5xl gap-0 p-0">
        <header className="p-mx-lg md:p-10 border-b border-border flex items-center justify-between">
        ...
        <DialogBody className="p-mx-lg md:p-10 space-y-mx-xl">
        ...
        <footer className="p-mx-lg md:p-10 border-t border-border flex justify-end gap-mx-sm">
          <Button
            variant="ghost"
            onClick={onClose}
