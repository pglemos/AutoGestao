        ...
        return (
          ...
          >
            <div className="relative mb-3 flex flex-col items-center">
              {isFirst && <Crown className="w-mx-lg h-mx-lg text-status-warning-text mb-2 drop-shadow-sm" />}
                ...
                <Avatar
                  ...
                  className={cn(
                    ...
                    isFirst
                      ...
                      : isSecond
                        ? 'w-mx-20 h-mx-20 sm:w-mx-20 sm:h-mx-20'
                        : 'w-mx-14 h-mx-14 sm:w-mx-20 sm:h-mx-20',
                  )}
                />
              </div>
              <div className={cn(
