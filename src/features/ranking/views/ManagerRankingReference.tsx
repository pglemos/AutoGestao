    ...
    <PageCanvas as="div" width="dashboard" bottomClearance="navigation" className="flex flex-col gap-5">
        ...
        {view === 'comparativo' ? (
          data.vendedores.length > 1
            ...
            : <div className="rounded-2xl border border-gray-100 bg-white p-10 text-center shadow-sm"><BarChart3 className="mx-auto mb-3 text-text-disabled" size={40} /><p className="text-sm font-medium text-muted-foreground">São necessários pelo menos dois vendedores no período para comparar.</p></div>
        ) : (
        <>
