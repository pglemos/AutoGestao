...
function RankingRow({ seller, index }: { seller: RankedVendedor; index: number }) {
  ...
  const rowTone = index === 0 ? 'border-l-4 border-yellow-400 bg-yellow-50' : index === 1 ? 'border-l-4 border-border-strong bg-gray-50' : index === 2 ? 'border-l-4 border-status-warning bg-status-warning-surface' : ''
  const positionTone = index === 0 ? 'bg-yellow-400 text-status-warning-foreground' : index === 1 ? 'bg-gray-400 text-status-warning-foreground' : index === 2 ? 'bg-status-warning text-status-warning-foreground' : 'bg-gray-100 text-muted-foreground'
