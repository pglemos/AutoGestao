  ...
  const refetch = useCallback(async () => {
    ...
    try {
      const { data: clients, error: clientsError } = await supabase
        ...
        .select('id, name, slug, cnpj, status, business_phase, product_name, program_template_key, structure_type, primary_store_id, implementation_owner_id, contract_end_date, onboarding_step, onboarding_completed')
