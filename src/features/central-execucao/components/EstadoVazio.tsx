...
export function EstadoVazio({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm sm:p-14">
      ...
      <p className="mx-auto mb-5 max-w-sm text-body-sm text-slate-400">
      ...
      <div className="flex flex-wrap items-center justify-center gap-3">
        ...
        <Link to="/carteira-clientes" className="flex items-center gap-1.5 rounded-xl border border-slate-200 px-4 py-2 text-body-sm font-bold text-slate-600 transition-colors hover:bg-slate-50">
