      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <select
            ...
            className="mt-1.5 h-10 w-full rounded-md border border-border bg-white px-3 text-body-sm text-foreground outline-none focus:border-status-info focus:ring-2 focus:ring-status-info/15"
          >
        ...
        {resultCode === 'sale_completed' && (
          <div>
            ...
            <input id="central-sale-value" type="number" min="0" step="0.01" value={value} onChange={event => setValue(event.target.value)} placeholder="R$ 0,00" className="mt-1.5 h-10 w-full rounded-md border border-border px-3 text-body-sm outline-none focus:border-status-info focus:ring-2 focus:ring-status-info/15" />
          </div>
        )}
        ...
        {resultCode === 'sale_lost' && (
          <div>
            ...
            <select id="central-loss-reason" value={lossReason} onChange={event => setLossReason(event.target.value)} className="mt-1.5 h-10 w-full rounded-md border border-border bg-white px-3 text-body-sm outline-none focus:border-status-info focus:ring-2 focus:ring-status-info/15">
        ...
        {selected?.requiresSchedule && (
          <div>
            ...
            <input id="central-reschedule" type="datetime-local" value={dueAt} onChange={event => setDueAt(event.target.value)} className="mt-1.5 h-10 w-full rounded-md border border-border px-3 text-body-sm outline-none focus:border-status-info focus:ring-2 focus:ring-status-info/15" />
          </div>
        )}
