...
export function AgendaFiltersBar({
  ...
  return (
    <div className="flex items-center justify-between py-1 px-1 bg-brand-primary/5 rounded-xl border border-brand-primary/10 my-1">
      <div className="flex items-center gap-2 text-xs font-semibold text-status-success-text">
        <Filter size={13} />
