    ...
    return (
        ...
        >
            <div className={`relative overflow-hidden bg-slate-900 ${large ? 'h-40' : 'h-28'}`}>
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-surface-overlay/25">
                                    ...
                                    <Card key={t.id} className="flex items-center gap-4 p-mx-md">
                                        ...
                                        {presencas.has(t.id) ? (
                                            ...
                                            <button
                                                ...
                                                className="rounded-2xl border border-brand-primary px-3 py-1.5 text-xs font-semibold text-status-success-text hover:bg-brand-primary/5"
                                            >
                                                Confirmar presença
                                            </button>
                                        )}
