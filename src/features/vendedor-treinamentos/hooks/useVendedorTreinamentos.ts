...
import { recomendarTreinamentos, type EtapaFunilAberta, type SinaisRecomendacao } from '@/features/universidade/services/recomendacao'
import { carregarSinaisRecomendacao } from '@/features/universidade/services/sinais-recomendacao'
...
export function useVendedorTreinamentos() {
    ...
    const fetchAll = useCallback(async () => {
        ...
        try {
            const [trainingsResult, perfilRes, sinaisResult] = await Promise.all([
                ...
                supabase
                    ...
                    .maybeSingle(),
                carregarSinaisRecomendacao(supabase, supabaseUser.id),
            ])
