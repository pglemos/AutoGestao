    ...
    <section className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm" aria-labelledby="mentor-library-title">
      ...
      <div className="relative mb-3">
        ...
        <input
          ...
          className="w-full rounded-xl border border-gray-100 bg-gray-50 py-2 pl-9 pr-3 text-sm transition-all focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500"
        />
      </div>
