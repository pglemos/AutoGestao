...
const fieldClass = 'w-full rounded-xl border border-gray-200 px-3 py-2 text-sm text-foreground outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20'
