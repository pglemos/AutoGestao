...
export default function ManagerTeamRoutineCanonical() {
  ...
  return <div className="min-h-full bg-gray-50"><div className="mx-auto flex w-full max-w-7xl flex-col gap-5 px-4 py-6 pb-24">
...
function RoutineSkeleton(){return <div className="space-y-mx-lg bg-gray-50 p-mx-lg" aria-busy="true"><Skeleton className="h-mx-20"/><div className="grid grid-cols-4 gap-mx-md">{Array.from({length:4}).map((_,i)=><Skeleton key={i} className="h-mx-32"/>)}</div><Skeleton className="h-[420px]"/></div>}
