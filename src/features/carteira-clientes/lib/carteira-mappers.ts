...
export function mapMxClientToCarteiraVisual(client: ClientRow, now = new Date()) {
  ...
  const wonOpportunity = latestClosed?.etapa === 'ganho' ? latestClosed : null

  return {
    id: client.id,
    cliente_id: client.id,
    oportunidade_id: opportunity?.id || wonOpportunity?.id || null,
    ...
    canal_venda: canalLabel(opportunity?.canal || wonOpportunity?.canal || client.canal_origem),
    ...
    veiculo_interesse: isCancelled ? '' : (opportunity?.veiculo_interesse || wonOpportunity?.veiculo_interesse || ''),
    ...
    interesse_troca: Boolean(opportunity?.carro_avaliado || wonOpportunity?.carro_avaliado),
    carro_avaliado: (opportunity?.carro_avaliado || wonOpportunity?.carro_avaliado) ? 'Sim' : 'Não',
    ...
    current_status_code: opportunity?.current_status_code || wonOpportunity?.current_status_code || null,
    categoria_veiculo: opportunity?.categoria_veiculo || wonOpportunity?.categoria_veiculo || null,
    preco_interesse_min: (opportunity?.preco_interesse_min ?? wonOpportunity?.preco_interesse_min) == null ? null : Number(opportunity?.preco_interesse_min ?? wonOpportunity?.preco_interesse_min),
    preco_interesse_max: (opportunity?.preco_interesse_max ?? wonOpportunity?.preco_interesse_max) == null ? null : Number(opportunity?.preco_interesse_max ?? wonOpportunity?.preco_interesse_max),
    ...
    motivo_perda: opportunity?.motivo_perda || latestClosed?.motivo_perda || '',
