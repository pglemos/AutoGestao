                ...
                <div className="grid md:grid-cols-2 gap-mx-md">
                    ...
                    <FormGroup icon={<Shield size={16} />} label="Papel/Hierarquia">
                        <select
                            ...
                            className="w-full h-mx-14 pl-mx-12 pr-mx-sm bg-surface-alt border border-border rounded-2xl font-bold uppercase text-xs focus:outline-none focus:border-brand-primary appearance-none cursor-pointer"
                        >
                    ...
                    <div className="md:col-span-2">
                        <label htmlFor="user-active" className="flex items-start gap-mx-sm rounded-2xl border border-border bg-surface-alt p-mx-md cursor-pointer">
                            <input
                                id="user-active"
                                name="active"
                                type="checkbox"
