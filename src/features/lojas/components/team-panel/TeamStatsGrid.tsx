    ...
    <div className="grid grid-cols-4 gap-mx-xs md:gap-mx-lg shrink-0 mt-mx-md">
      {stats.map((item, idx) => (
        <motion.div
          ...
          className="p-mx-xs sm:p-mx-lg rounded-2xl sm:rounded-mx-4xl bg-white border border-gray-200 relative overflow-hidden group shadow-sm hover:shadow-sm transition-all h-mx-16 sm:h-mx-24 flex items-center"
        >
          ...
          <div className="flex items-center justify-between relative z-10 w-full">
            ...
            <div className={cn(
              "hidden sm:flex w-mx-12 h-mx-12 rounded-2xl items-center justify-center bg-white shadow-sm border border-gray-200 text-muted-foreground transition-all group-hover:rotate-6 group-hover:border-brand-primary/20 group-hover:text-emerald-600",
