  ...
  return (
    <aside className="order-2 min-w-0 xl:sticky xl:top-[var(--spacing-mx-layout-offset-top)]">
      <Card className="border bg-white overflow-hidden">
        <CardHeader className="border-b border-gray-200 bg-gray-50/60 p-mx-md">
        ...
        <CardContent className="p-mx-md mx-pre-registration-scroll">
          {!canApprovePreRegistrations ? (
            <div className="rounded-2xl border border-dashed border-gray-200 bg-gray-50 p-mx-lg text-center">
            ...
            <div className="grid grid-cols-1 gap-mx-sm">
              {preRegistrations.map(item => {
                ...
                return (
                <div key={item.id} className="rounded-2xl border border-gray-200 bg-gray-50 p-mx-sm">
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-mx-sm">
                    <div className="flex items-start gap-mx-sm min-w-0">
                      <div className="h-mx-14 w-mx-14 overflow-hidden rounded-2xl border border-gray-200 bg-white shrink-0">
            ...
            <div className="rounded-2xl border border-dashed border-gray-200 bg-gray-50 p-mx-md text-center">
