...
export function ConsultingJourneyWorkspace() {
  ...
  return (
    <div className="space-y-5 pb-12">
      ...
      {snapshot.confidentialityLevel === 'restricted' ? <div className="rounded-xl border border-slate-300 bg-slate-50 p-4 text-sm text-slate-800"><strong>Confidencialidade PPA:</strong> conteúdo estratégico restrito e auditável.</div> : null}
