            ...
            <form onSubmit={handleSubmit} className="p-mx-xl sm:p-mx-2xl space-y-mx-lg">
              ...
              <div className="space-y-mx-md">
                ...
                <button 
                  type="button"
                  onClick={() => signOut()}
                  className="w-full flex items-center justify-center gap-mx-xs text-muted-foreground hover:text-status-error-text font-bold uppercase tracking-mx-widest text-mx-tiny py-mx-xs transition-colors"
                >
