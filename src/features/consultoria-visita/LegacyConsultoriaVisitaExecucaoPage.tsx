    ...
    <PageCanvas as="div" width="dashboard" bottomClearance="navigation" className="w-full pb-mx-xl relative z-[var(--mx-z-base)]">
      ...
      <div className="sticky top-mx-0 z-[var(--mx-z-topbar)] bg-surface-alt/80 backdrop-blur-xl px-mx-md py-mx-sm flex flex-col md:flex-row md:items-center justify-between gap-mx-sm mb-mx-md print:hidden border-b border-border-subtle shadow-sm transition-all">
        ...
        <div className="grid grid-cols-2 gap-mx-sm w-full md:flex md:items-center md:w-auto">
          <Button variant="outline" className="w-full md:w-auto h-mx-11 text-xs bg-white px-mx-sm md:px-mx-md hover:bg-surface-alt transition-all" onClick={() => handleSave(false)} loading={isSaving}>SALVAR</Button>
        ...
        <div className="lg:col-span-2 space-y-mx-lg">
          ...
          <div className="rounded-2xl border border-border bg-white p-mx-md shadow-sm">
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-mx-sm">
              {VISIT_FLOW_STEPS.map((item, index) => (
                <div key={item} className="min-h-mx-14 rounded-2xl border border-border-subtle bg-surface-alt/40 px-mx-sm py-mx-xs">
          ...
          <Card className="p-mx-lg border bg-white overflow-hidden">
            <div className="flex flex-col gap-mx-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-mx-md">
                ...
                <div className="space-y-mx-xs">
                  <Typography as="label" variant="caption" className="">Fim</Typography>
                  <DatePicker
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-mx-lg">
            ...
            <div className="space-y-mx-lg">
              ...
              <Card className="p-mx-lg border bg-gradient-to-br from-white to-surface-alt relative overflow-hidden group">
        ...
        <div className="lg:col-span-1 space-y-mx-lg print:hidden">
          <Card className="p-mx-lg border bg-white overflow-hidden relative">
            ...
            <div className="space-y-mx-md">
              <div className="p-mx-md bg-surface-alt rounded-2xl border border-border-subtle">
          ...
          <Card className="p-mx-lg border bg-white">
            ...
            {attachments.length === 0 ? (
               ...
               <div className="space-y-mx-md">
                  {attachments.map(att => (
                     <div key={att.id} className="group p-mx-xs bg-surface-alt rounded-2xl border border-border flex items-center justify-between hover:bg-white transition-colors shadow-sm">
          ...
          <Card className="p-mx-lg bg-white border text-center">
             ...
             <div className="space-y-mx-md">
               ...
               {visit?.status === 'concluida' && (
                 <Button
                   className={cn("w-full shadow-sm font-bold h-mx-11 uppercase tracking-widest text-xs", visit.acknowledged_at ? "bg-status-success/10 text-status-success border-status-success/20 hover:bg-status-success/20" : "")}
                   variant="outline"
