  ...
  return (
    <MxModulePage id="consultant-assigned-clients" width={pageWidth} bottomClearance={pageBottomClearance}>
      <MxModuleHeader
        ...
        actions={<><Button asChild variant="outline"><Link to="/agenda"><CalendarDays size={18} />Agenda MX</Link></Button><Button variant="outline" onClick={() => void refetch()}><RefreshCw size={18} />Atualizar</Button></>}
      />
