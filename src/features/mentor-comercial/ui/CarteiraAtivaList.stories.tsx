...
const listNormal: CarteiraOportunidade[] = [
  {
    id: 'op-201',
    cliente_id: 'cli-201',
...
const listComNeedsClassification: CarteiraOportunidade[] = [
  ...listNormal,
  {
    id: 'op-204',
    cliente_id: 'cli-204',
...
const listSemScoreSemPrioridade: CarteiraOportunidade[] = [
  {
    id: 'op-205',
    cliente_id: 'cli-205',
...
const meta: Meta<typeof CarteiraAtivaList> = {
  title: 'Mentor Comercial/CarteiraAtivaList',
  component: CarteiraAtivaList,
  parameters: {
    layout: 'padded',
  },
  tags: ['autodocs'],
...
export default meta
type Story = StoryObj<typeof CarteiraAtivaList>

export const EstadoNormal: Story = {
  args: {
    oportunidades: listNormal,
    loading: false,
  },
}

export const ComClassificacaoPendente: Story = {
  args: {
    oportunidades: listComNeedsClassification,
    loading: false,
  },
}
...
export const SemScoreSemPrioridade: Story = {
  args: {
    oportunidades: listSemScoreSemPrioridade,
    loading: false,
  },
}

export const PrioridadeMaximaEBaixa: Story = {
  args: {
    oportunidades: listNormal,
    loading: false,
  },
