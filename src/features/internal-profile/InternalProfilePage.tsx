    ...
    <MxModulePage id="internal-profile">
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-12">
        ...
        <div className="space-y-5 lg:col-span-8">
          ...
          <MxSectionCard><MxSectionHeader title="Segurança" description="A senha nunca é exibida ou armazenada nesta tela." actions={<Button variant="outline" onClick={() => state.setPasswordOpen(true)} disabled={!state.canEdit}><Key size={18} />Alterar senha</Button>} /><div className="flex items-center gap-3 p-5 text-sm text-muted-foreground"><ShieldCheck className="text-emerald-600" size={20} />Verificação de acesso ativa.</div></MxSectionCard>
        </div>
      </div>
