...
export default function Simulacao() {
  ...
  return (
    <MxModulePage id="simulation-selector">
      <MxModuleHeader eyebrow="Simulação" title="Simulação de Perfis" description="Valide as experiências reais de Vendedor, Gerente e Dono sem substituir sua identidade administrativa." actions={isSimulating ? <Button variant="outline" onClick={() => { stopSimulation(); navigate('/simulacao', { replace: true }) }}>Encerrar simulação</Button> : undefined} />
