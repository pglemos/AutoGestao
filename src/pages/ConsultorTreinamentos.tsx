                ...
                actions={
                    <div className="flex items-center gap-mx-sm shrink-0">
                        <Button 
                            ...
                            className="w-mx-xl h-mx-xl rounded-xl shadow-sm border border-gray-100 bg-white hover:bg-gray-50"
                        >
                    ...
                    <motion.section initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95 }} className="shrink-0 mb-10">
                        <form onSubmit={handleSubmit}>
                            <Card className="border p-mx-md bg-white relative">
                                ...
                                <footer className="pt-10 flex justify-end gap-mx-sm border-t border-gray-100 mt-10 relative z-10">
                ...
                <Card className="border bg-white p-mx-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-mx-sm">
                        {suggestions.slice(0, 9).map(suggestion => (
                            <div key={suggestion.id} className="rounded-xl border border-gray-100 bg-gray-50/50 p-mx-md">
                        ...
                        <Card className="border bg-white p-mx-md hover:shadow-sm transition-all relative flex flex-col">
                            ...
                            <footer className="pt-6 border-t border-gray-100 flex items-center justify-between mt-auto relative z-10">
                                <div className="flex -space-x-2">
                                    ...
                                    <div className="w-mx-lg h-mx-lg rounded-xl border border-gray-100 bg-mx-indigo-50 flex items-center justify-center text-emerald-600 shadow-sm">
