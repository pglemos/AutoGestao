...
export const INTERNAL_MX_PAGE_REGISTRY: readonly InternalMxPageMeta[] = [
  ...
  { key: 'plano-estrategico', title: 'Plano Estratégico', description: 'Indicadores reais, metas, comparativos, direcionamentos e ações por loja.', group: 'Rede e Gestão', managerLayout: true, template: 'workspace', match: exact('/plano-estrategico') },
  { key: 'plano-acao', title: 'Planos de Ação', description: 'Modelos de ação da metodologia MX para aplicação nos clientes e sugestão aos Donos.', group: 'Rede e Gestão', managerLayout: true, template: 'workspace', match: exact('/plano-acao') },
  ...
  { key: 'ranking', title: 'Ranking', description: 'Classificação, evolução e leitura comparativa de performance.', group: 'Rotina e Conteúdo', managerLayout: true, template: 'dashboard', match: oneOf('/ranking', '/classificacao') },
  ...
  { key: 'universidade-mx', title: 'Universidade MX', description: 'Conteúdos, trilhas, aulas e evolução da Universidade MX.', group: 'Rotina e Conteúdo', managerLayout: true, template: 'list', match: oneOf('/universidade-mx', '/treinamentos') },
  { key: 'produtos', title: 'Produtos de Consultoria', description: 'Catálogo dos programas de consultoria: ciclo de vida, módulos e capacidade.', group: 'Rotina e Conteúdo', managerLayout: true, template: 'list', match: exact('/produtos') },
