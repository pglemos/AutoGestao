  ...
  const sections: MxSidebarNavSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'reprocessing', label: 'Dados e Conciliação', path: '/configuracoes/reprocessamento', icon: Database, activePaths: ['/configuracoes/reprocessamento', '/dados', '/dados-conciliacao'] },
