...
export const SIDEBAR_METRICS = {
  ...
  /** Menor alvo de toque para controles interativos (WCAG AAA / DS MX). */
  touchTargetMin: 44,
  /** Altura de um item de navegação — alinhada ao touch target. */
  itemHeight: 44,
  /** Altura de um subitem — mínimo de toque confortável. */
  nestedItemHeight: 40,
...
export const SIDEBAR = {
  ...
  aside: 'hidden shrink-0 border-r border-mxsb-line font-sans text-[14px] leading-normal text-mxsb-base antialiased xl:block motion-safe:transition-[width] motion-safe:duration-300 motion-safe:ease-out motion-reduce:transition-none',
  ...
  /** Item de navegação. */
  item: 'group relative flex w-full min-h-[var(--mx-sidebar-item-height)] items-center gap-2.5 rounded-[var(--mx-sidebar-item-radius)] py-2 text-sm font-medium outline-none transition-colors focus-visible:ring-2 focus-visible:ring-status-success/30 active:bg-mxsb-hover',
  itemExpanded: 'px-3',
  ...
  /** Grupo expansível. */
  groupTrigger:
    'flex w-full min-h-[var(--mx-sidebar-item-height)] items-center gap-2.5 rounded-[var(--mx-sidebar-item-radius)] py-2 text-sm font-medium text-mxsb-muted outline-none transition-colors hover:bg-mxsb-hover hover:text-mxsb-ink-strong active:bg-mxsb-hover focus-visible:ring-2 focus-visible:ring-status-success/30 disabled:pointer-events-none disabled:opacity-50',
  groupChevron: 'h-3.5 w-3.5 shrink-0',
  subnav: 'ml-3 mt-0.5 space-y-0.5 border-l border-mxsb-line pl-3',
  nestedItem:
    'flex w-full min-h-[var(--mx-sidebar-nested-item-height)] items-center gap-1.5 rounded-[var(--mx-sidebar-subitem-radius)] px-2.5 py-1.5 text-body-sm outline-none transition-colors active:bg-mxsb-hover focus-visible:ring-2 focus-visible:ring-status-success/30',
  ...
  ctaButton:
    'flex h-11 w-full items-center gap-2.5 rounded-[var(--mx-sidebar-subitem-radius)] bg-mxsb-active px-4 text-sm font-medium text-[hsl(var(--mx-neutral-0))] outline-none transition-colors hover:bg-mxsb-active/90 active:bg-mxsb-active/80 focus-visible:ring-2 focus-visible:ring-status-success/30 disabled:pointer-events-none disabled:opacity-50',
  ...
  drawerPanel:
    'relative z-[var(--mx-z-sticky)] flex h-full w-[var(--mx-sidebar-drawer-width)] max-w-[var(--mx-sidebar-drawer-max-width)] flex-col overflow-hidden bg-mxsb-surface shadow-[var(--mx-shadow-xl)] sm:w-[var(--mx-sidebar-drawer-width-sm)] sm:max-w-sm',
  drawerClose:
    'absolute right-2 top-2 z-[var(--mx-z-sticky)] flex h-[var(--mx-mobile-header-touch-target)] w-[var(--mx-mobile-header-touch-target)] items-center justify-center rounded-[var(--mx-sidebar-drawer-close-radius)] text-mxsb-ink outline-none transition-colors hover:bg-mxsb-hover focus-visible:ring-2 focus-visible:ring-status-success/30',

  /** Superfícies flutuantes (tooltip / menus). */
  floatingSurface:
    'rounded-[var(--mx-radius-lg)] border border-border-subtle bg-mxsb-surface text-foreground shadow-[var(--mx-shadow-lg)]',
  floatingMenu:
    'rounded-[var(--mx-radius-2xl)] border border-border-subtle bg-mxsb-surface p-2 shadow-[var(--mx-shadow-xl)]',
} as const
