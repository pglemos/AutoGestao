        ...
        >
          <div className="flex items-start justify-between gap-mx-sm">
            ...
            <Popover.Close asChild>
              <button type="button" aria-label="Fechar" className="shrink-0 rounded-xl p-1 text-muted-foreground transition-colors hover:bg-surface-alt hover:text-foreground">
                <X size={14} />
              </button>
            </Popover.Close>
          </div>
          ...
          <div className="mt-mx-sm flex flex-wrap gap-mx-xs border-t border-border pt-mx-sm">
