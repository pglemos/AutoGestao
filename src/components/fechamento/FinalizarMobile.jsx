...
export default function FinalizarMobile({
  ...
  return (
    <div className="bg-white rounded-2xl border border-border shadow-sm p-4 space-y-4">
      {/* Avisos */}
      {isBlocked && (
        <div className="flex items-start gap-3 bg-status-error-surface border border-status-error/30 rounded-xl px-4 py-3">
          ...
          <div className="flex-1">
            ...
            {solicitacaoEnviada ? (
              ...
              <button
                ...
                disabled={enviando}
                className="mt-2 flex items-center gap-1.5 text-body-sm font-bold text-white bg-status-success hover:bg-brand-primary disabled:opacity-60 px-4 py-2 rounded-xl transition-colors"
              >
      ...
      {liberado && !jaFinalizado && (
        <div className="flex items-center gap-2 bg-status-warning-surface border border-status-warning/30 rounded-xl px-4 py-3">
      ...
      {jaFinalizado && d1Bloqueado && (
        <div className="flex items-center gap-2 bg-surface-alt border border-border rounded-xl px-4 py-3">
      ...
      {!jaFinalizado ? (
        <div className="space-y-3">
          <button
            ...
            className={`w-full flex items-center justify-center gap-3 py-4 rounded-2xl text-white font-bold text-body tracking-widest uppercase transition-all active:scale-[0.98] disabled:cursor-not-allowed shadow-md
              ${isBlocked
                ? "bg-status-error shadow-red-200 opacity-70"
        ...
        <div className="flex items-center justify-center gap-2 py-2 text-[14px] font-semibold text-status-success">
