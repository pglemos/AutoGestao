...
const buttonVariants = cva(
  "group relative inline-flex items-center justify-center gap-mx-xs whitespace-nowrap rounded-[var(--mx-button-radius)] font-semibold tracking-normal transition-[background-color,box-shadow,transform] duration-fast focus-visible:ring-4 focus-visible:ring-mx-action/20 outline-none disabled:pointer-events-none disabled:bg-surface-alt disabled:text-mx-muted disabled:opacity-100 data-[legacy-disabled=true]:disabled:opacity-50 active:scale-[0.98] active:duration-fast [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
