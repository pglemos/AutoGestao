      ...
      <Tooltip open={open} onOpenChange={setOpen}>
        <TooltipTrigger asChild>
          <button
            ...
            className={`inline-flex cursor-help items-center justify-center border-0 bg-transparent p-0 align-middle text-muted-foreground transition-colors hover:text-emerald-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/30 ${className}`}
          >
