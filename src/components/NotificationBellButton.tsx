  ...
  return (
    <div ref={containerRef} className={cn('relative', className)}>
      ...
      >
        <Bell size={20} />
        {unreadCount > 0 && (
          <span className="absolute -right-1 -top-1 grid h-4 min-w-4 place-items-center rounded-full bg-status-error px-1 text-caption font-bold leading-none text-status-error-foreground">
