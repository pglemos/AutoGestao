      ...
      {tabs.map(({ key, label, controls }) => {
        ...
        return (
          <button
            ...
            className={cn(
              'px-mx-md py-mx-sm text-xs font-bold uppercase tracking-mx-widest transition-all border-b-2 whitespace-nowrap',
              activeTab === key
                ? 'border-brand-primary text-emerald-600 bg-emerald-600/5'
