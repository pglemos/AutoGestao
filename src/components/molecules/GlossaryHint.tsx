...
export function GlossaryHint({ term, definition, className }: GlossaryHintProps) {
  return (
    <abbr
      ...
      className={cn('inline-flex cursor-help items-center gap-mx-tiny rounded-mx-full border border-border bg-white/80 px-mx-xs py-mx-tiny text-current no-underline', className)}
    >
      <span>{term}</span>
