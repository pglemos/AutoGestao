          ...
          {actions.map((action) => {
            ...
            return (
              <button
                ...
                className={`w-full rounded-lg border bg-card px-2 py-1.5 text-left text-xs shadow-xs hover:shadow-sm ${deptStyle.border || "border-border"} ${late ? "border-status-error/50 bg-status-error-surface/30" : ""}`}
              >
